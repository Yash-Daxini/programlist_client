      ...
      <div className="homeMain p-1">
        <div className="homeMainChild">
          <div className="w-50 codeIconDiv">
            <h1>
              <ion-icon className="icon" name="code-slash-outline"></ion-icon>
            </h1>
          </div>
          <div className="m-4">
            <h1 className="text-light m-5">A New Way to Learn</h1>
            <p className="homepageDescription">
              Best platform to help you enhance your skills,
              <br /> expand your knowledge and prepare for technical interviews.
            </p>
          </div>
        </div>
